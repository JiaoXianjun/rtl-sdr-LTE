function add_header_to_hackrf_bin(bin_filename, fc_requested, fc_programmed, fs_requested, fs_programmed)

conv_raw_hackrf_signed_bin_to_unsigned_bin(bin_filename);
